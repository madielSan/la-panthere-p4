...
function addKeyBoardSupport(){$(window).on(function(t){37==t.which?$(".prev-lightbox").is(":visible")&&$(".prev-lightbox").on():39==t.which&&$(".next-lightbox").is(":visible")&&$(".next-lightbox").click()})}
$(document).ready(function(){$("#scroll-hero").on(function(t){}),extraNavFuncs(),setUpSpecialNavs(),setUpDropdownSubs(),setUpLightBox(),setUpVisibilityToggle(),addSwipeSupport(),addKeyBoardSupport(),-1!=navigator.userAgent.indexOf("Safari")&&-1==navigator.userAgent.indexOf("Chrome")&&$("#page-loading-blocs-notifaction").remove()}),$(window).load(function(){setFillScreenBlocHeight(),animateWhenVisible(),$("#page-loading-blocs-notifaction").remove()})